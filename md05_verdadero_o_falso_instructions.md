...
👉 Operador de comparación: MAYOR QUE `>`, MENOR QUE `<`.  
...
👉 Operador de comparación: MAYOR O IGUAL QUE `>=`, MENOR O IGUAL QUE `<=`.  
...
Desarrolla un programa sencillo donde el usuario deberá introducir 2 números en total. El programa __deberá analizar dichos números__ y decirnos sí:
...
Crea en esta segunda actividad una aplicación donde el usuario tenga que introducir un número al azar y __el sistema detecte si es par y está entre 0 y 100__.  
...
* En Python los operadores lógicos y de comparación son los siguientes:
  * Comparación:
    * Igual: `==` 👉 print(n1 == n2)
    * Diferente: `!=` 👉 print(n1 != n2)
    * Mayor: `>` 👉 print(n1 > n2)
    * Menor: `<` 👉 print(n1 < n2)
    * Mayor o igual: `>=` 👉 print(n1 >= n2)
    * Menor o igual: `<=` 👉 print(n1 <= n2)
  * Lógicos:
    * Y: `and` 👉 print(pedro_musico and pedro_saxofonista)
    * O: `or` 👉 print(araceli_deportista or araceli_trabajadora)
    * No: `not` 👉 print(not(juan_maestro))
